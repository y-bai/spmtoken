...
# -*-coding:utf-8 -*-
"""
@File    :		_unigram_tokenizer_fast.py
@Time    :   	2024/04/07 11:15:28
@Author  :   	Yong Bai 
...
VOCAB_FILES_NAMES = {"vocab_file": "unigram.json", "tokenizer_file": "tokenizer.json"}
...
class BioSeqUnigramTokenizerFast(PreTrainedTokenizerFast):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if tokenizer_file is None:
            ...
            slow_tokenizer = BioSeqUnigramTokenizer(
                ...
                **kwargs)
            tokenizer_object = BioSeqUnigramConverter(slow_tokenizer).converted()
        else:
